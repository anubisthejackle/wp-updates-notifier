 ...
 */
class Notify_Automatic implements Validator {
	...
	private function invalid() {
		add_settings_error(
			...
			__( 'Invalid automatic updates value entered', 'wp-updates-notifier' ),
			'error'
		);

		return Settings::get_instance()->get( 'notify_automatic' );
	}
}
